...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request,'You have already made an enquiry about this car. Please wait untill we get back to you.')
        ...
        send_mail(
            "New Car Inquiry",
            "You have a new car inquiry for "+ car_title + ", Please login to admin panel for more info.",
